...
The second is a completely separate project: the [build log behind this site](/workshop/building-this-site), which just went from a pile of unpublished drafts to a real, browsable structure. It has its own three levels, for its own reasons — the whole project rolled up into one page with real stats, seven chapters each with their own recap, and twenty-five individual entries underneath those for anyone who wants the raw, dated account of one specific decision. Nobody has to read all twenty-five to get the shape of how this site got built. But they're there, organized well enough to actually be worth opening, for whoever wants them.
